! function() {
	...
	var a, t = function(e, s) {
		...
		var h = {};
		for(var f in s)
			if("object" != typeof s[f] || null === s[f] || s[f].nodeType || s[f] === window || s[f] === document || "undefined" != typeof Dom7 && s[f] instanceof Dom7 || "undefined" != typeof jQuery && s[f] instanceof jQuery) h[f] = s[f];
			else {
				h[f] = {};
					...
					if(e.originalEvent && (e = e.originalEvent), H = "touchstart" === e.type, H || !("which" in e) || 3 !== e.which) {
						...
						if(!y.params.swipeHandler || n(e, y.params.swipeHandler)) {
							...
							if(!(y.device.ios && y.params.iOSEdgeSwipeDetection && t <= y.params.iOSEdgeSwipeThreshold)) {
								if(x = !0, S = !1, C = !0, M = void 0, A = void 0, y.touches.startX = t, y.touches.startY = s, z = Date.now(), y.allowClick = !0, y.updateContainerSize(), y.swipeDirection = void 0, y.params.threshold > 0 && (k = !1), "touchstart" !== e.type) {
									var i = !0;
						...
						if(C && y.emit("onTouchMove", y, e), !(e.targetTouches && e.targetTouches.length > 1)) {
							...
							if(M && y.emit("onTouchMoveOpposite", y, e), "undefined" == typeof A && y.browser.ieTouch && (y.touches.currentX !== y.touches.startX || y.touches.currentY !== y.touches.startY) && (A = !0), x) {
								...
								if(A || !y.browser.ieTouch) {
									...
									var r = !0;
									if(i > 0 && P > y.minTranslate() ? (r = !1, y.params.resistance && (P = y.minTranslate() - 1 + Math.pow(-y.minTranslate() + I + i, y.params.resistanceRatio))) : 0 > i && P < y.maxTranslate() && (r = !1, y.params.resistance && (P = y.maxTranslate() + 1 - Math.pow(y.maxTranslate() - I - i, y.params.resistanceRatio))),
	...
	s.length > 0 && (t = !1);
	var i = new Swiper(".homepage-banner .swiper-container", {
			loop: !0,
			autoplay: t,
			keyboardControl: !0,
			effect: "fade",
	...
	$(window).on("visibilitychange", function() {
		document.hidden ? i.autoplaying && (r = !0, i.stopAutoplay()) : r && (r = !1, i.startAutoplay())
