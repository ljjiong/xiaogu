...
{
    protected $rule = [
        ['id', 'require|checkValue:id', '商品ID不能为空'],
        ['goods_cate_id', 'require|checkValue:goods_cate_id', '商品类别不能为空'],
        ...
        ['stock', 'number|>=:0', '商品库存数量值必须为数值|商品库存不能小于0'],
        ['weight', 'number|>=:0', '商品重量必须为数值|商品重量不能小于0'],
        ['cost_price', 'number|>=:0', '商品成本价必须为数值|商品成本价不能小于0'],
        ['sell_price', 'number|>=:0', '商品销售价必须为数值数|商品销售价不能小于0'],
        ['market_price', 'number|>=:0', '商品市场价必须为数值|商品市场价不能小于0'],
        ['red_price', 'number|>=:0', '商品红包价必须为数值|商品红包价不能小于0'],
        ['sell_num', 'number|>=:0', '商品销售量必须为整数|商品销售量不能小于0'],
        ['click_num', 'number|>=:0', '商品点击量必须为整数|商品点击量不能小于0'],
        ['collect_num', 'number|>=:0', '商品收藏量必须为整数|商品收藏量不能小于0'],
        ['sort', 'number|>=:0', '商品排序值必须为整数|商品排序值不能小于0'],
        ['is_top', 'in:0,1', '是否置顶商品不能为空|是否置顶商品值非法'],
        ['score', 'in:1,2,3,4,5', '商品综合评分不能为空|商品综合评分值非法'],
        ['status', 'in:1,2', '商品状态不能为空|商品状态值非法'],
