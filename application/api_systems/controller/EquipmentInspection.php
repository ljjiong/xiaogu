...
class EquipmentInspection extends Rest
{
    ...
    public function index(Request $request)
    {
        ...
        $count = model('equipment_inspection')->getAllCount($map);
        $lists = model('equipment_inspection')->getAll($map, $this->page_num, $this->page_limit);
    ...
    public function save(Request $request)
    {
        ...
        $result = model('equipment_inspection')->addOne($data);
        if ($result['code']) {
            $this->data['msg']  = '新增成功';
    ...
    public function update(Request $request)
    {
        ...
        $result = model('equipment_inspection')->editOne($data);
        if ($result['code']) {
            $this->data['msg']  = '更新成功';
            $this->data['data'] = $result['data'];
        } else {
    ...
    public function batch_delete(Request $request)
    {
        ...
        $result = model('equipment_inspection')->delAll($ids);
        if ($result['code']) {
    ...
    public function export(Request $request)
    {
        ...
        $lists = model('equipment_inspection')->getAll($map);
        ...
        foreach ($lists as $key => $val) {
            ...
            $export_data[] = [
                ...
                'name'           => $val['name'],
                'inspection_results'     => $val['inspection_results'],
                'inspectors'   => $val['inspectors'],
