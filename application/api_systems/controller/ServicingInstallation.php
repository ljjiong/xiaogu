...
class ServicingInstallation extends Rest
{
    ...
    public function index(Request $request)
    {
        ...
        $count = model('servicing_installation')->getAllCount($map);
        $lists = model('servicing_installation')->getAll($map, $this->page_num, $this->page_limit);
    ...
    public function save(Request $request)
    {
        ...
        $result = model('servicing_installation')->addOne($data);
        if ($result['code']) {
            $this->data['msg']  = '新增成功';
    ...
    public function update(Request $request)
    {
        ...
        $result = model('servicing_installation')->editOne($data);
        if ($result['code']) {
            $this->data['msg']  = '更新成功';
            $this->data['data'] = $result['data'];
        } else {
    ...
    public function batch_delete(Request $request)
    {
        ...
        $result = model('servicing_installation')->delAll($ids);
        if ($result['code']) {
    ...
    public function export(Request $request)
    {
        ...
        $lists = model('servicing_installation')->getAll($map);
        ...
        foreach ($lists as $key => $val) {
            ...
            $export_data[] = [
                ...
                'name'           => $val['name'],
                'guy_single'     => $val['guy_single'],
                'failure_cause'   => $val['failure_cause'],
                'serviceman'      => $val['serviceman'],
