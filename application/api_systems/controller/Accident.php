...
class Accident extends Rest
{
    ...
    public function index(Request $request)
    {
        ...
        $count = model('accident')->getAllCount($map);
        $lists = model('accident')->getAll($map, $this->page_num, $this->page_limit);
    ...
    public function save(Request $request)
    {
        ...
        $result = model('accident')->addOne($data);
        if ($result['code']) {
            $this->data['msg']  = '新增成功';
    ...
    public function update(Request $request)
    {
        ...
        $result = model('accident')->editOne($data);
        if ($result['code']) {
            $this->data['msg']  = '更新成功';
            $this->data['data'] = $result['data'];
        } else {
    ...
    public function batch_delete(Request $request)
    {
        ...
        $result = model('accident')->delAll($ids);
        if ($result['code']) {
    ...
    public function export(Request $request)
    {
        ...
        $lists = model('accident')->getAll($map);
