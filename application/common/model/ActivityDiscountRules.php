...
{
    // 指定数据表
    protected $table = 'work_activity_discount_rules';
    ...
    protected $type = [
        ...
        'user_level_ids'     => 'json',
        'user_limit_buy_num' => 'integer',
        'total_goods_num'    => 'integer',
        'use_num'            => 'integer',
        'status'             => 'integer',
        'data_state'         => 'integer',
    ];
    ...
    {
        $activity = model('market_activities')
            ->getOne($data['market_activity_id']);
