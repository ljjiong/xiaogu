 ...
 *  【商品分红信息模型】
 */
class GoodsBonus extends BaseModel
{
    // 指定数据表
    protected $table = 'wancll_goods_bonus';
    ...
    protected static function init()
    {
        ...
        self::afterDelete(function ($model) {
            model('bonus_goods_levels', 'bonus_model')->where(['goods_id' => ($model->goods_id)])->delete();
        });
    }
    ...
    public function addOne($param)
    {
        ...
        if (false === $result) {
            ...
            return ['code' => 1, 'data' => $this->getOne($this->goods_id), 'msg' => '添加商品分红信息成功'];
        }
    }
    ...
    public function editOne($param)
    {
        ...
        if (false === $result) {
            ...
            return ['code' => 1, 'data' => $this->getOne($param['goods_id']), 'msg' => '更新商品分红信息成功'];
        }
    ...
    public function delOne($id)
    {
        ...
        if (false === $result) {
            ...
            return ['code' => 1, 'data' => [], 'msg' => '删除商品分红信息成功'];
        }
    }
    ...
    public function delAll($ids)
    {
        ...
        if (false === $result) {
            ...
            return ['code' => 1, 'data' => [], 'msg' => '批量删除商品分红信息成功'];
        }
    }
