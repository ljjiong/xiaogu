 ...
 *  【分红商佣金日志模型】
 */
class UserBonusLogs extends BaseModel
{
    // 指定数据表
    protected $table = 'wancll_user_bonus_logs';
    ...
    protected $type = [
        ...
        'bonus_type'             => 'integer',
        'expect_money'           => 'float',
        'real_bonus_money'       => 'float',
        'real_bonus_rate'        => 'float',
        'real_money'             => 'float',
        'already_drawcash_money' => 'float',
        'source_user_id'         => 'integer',
        'order_status'           => 'integer',
        'status'                 => 'integer',
        'bonus_apply_id'         => 'integer',
        'data_state'             => 'integer',
    ];
    ...
    {
        $lists = Db::query('
            SELECT id,order_id,order_status,user_id FROM wancll_user_bonus_logs
