...
$(function(){
    ...
    var currentCity = cityObj["广州"], // 默认值，否则获取不到容易出错
        MA = {
            setCurrentCity: function(city){
                currentCity = cityObj[city];
                $("#dqcity").text(currentCity.label);
    ...
    AMap.event.addListener(mapObj, "click", function(e){
        ...
        //将值赋值给后台的文本框
	    parent.$('#longitude').val(e.lnglat.getLng().toString());
	    parent.$('#latitude').val(e.lnglat.getLat().toString());
